...
def main():
    ...
    if args.do_predict == False:
        #<-- Berry add create csvfile to log the EM and LOSS
        import csv
        csvfile = open('./QA_training_log.csv', 'w')
        writer = csv.writer(csvfile)
        writer.writerow(['epoch', 'total_loss', 'exact_match', 'f1'])
        ...
        for epoch in range(starting_epoch, args.num_train_epochs):
            ...
            writer.writerow([ epoch, total_loss.item() , eval_metric['exact_match']/100, eval_metric['f1']/100 ])
